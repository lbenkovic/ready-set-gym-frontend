    ...
    <div class="profile-container">
        ...
        <main class="main-content">
            ...
            <section v-if="isGymBrosModalVisible" class="gym-bros-modal">
                ...
                <button @click="toggleGymBrosModal" class="close-btn">
                    Close
                </button>
            </section>
                ...
                <div v-if="diaries.length > 0">
                    ...
                    >
                        <div class="diary-header">
                            ...
                            <button
                                @click="deleteDiaryEntry(diary._id)"
                                class="delete-btn"
                            >
...
export default {
    ...
    setup() {
        ...
        const fetchUserDiaries = async () => {
            const diariesResponse =
                await userDiaryCollectionStore.getUserDiary();
            if (diariesResponse) {
        ...
        const deleteDiaryEntry = async (diaryId) => {
            const res = await userDiaryCollectionStore.deleteDiaryEntry(
                diaryId
            );
            if (res) {

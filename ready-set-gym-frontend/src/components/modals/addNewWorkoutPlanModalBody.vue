...
export default {
    ...
    setup() {
        ...
        const closeModal = () => {
            ...
            firstHalfExercises.value.forEach((x) => {
                x.selected = false;
            });
            secondHalfExercises.value.forEach((x) => {
                x.selected = false;
            });
        ...
        const saveNewWorkoutPlan = async (imageUrl) => {
            try {
                ...
                const res =
                    await workoutPlansCollectionStore.saveNewUserWorkoutPlan(
                        formData
                    );
    ...
    methods: {
        ...
        async getExercises() {
            try {
                ...
                console.log(res);
                this.exercises = res.data.data.exerciseList;
